...
background_image = pygame.image.load("C:/Users\Professional/Desktop/PP2/Lab 9/Racer/Images/AnimatedStreet.png")
...
# background sound
pygame.mixer.music.load('C:/Users/Professional/Desktop/PP2/Lab 9/Racer/Music/Lab 9_racer_music_back music.wav')
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Professional/Desktop/PP2/Lab 9/Racer/Images/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Professional/Desktop/PP2/Lab 9/Racer/Images/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Professional/Desktop/PP2/Lab 9/Racer/Images/red coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, screen_width - 40), 0)
...
# После обновления всех спрайтов вызовите функцию обновления экрана:
    ...
    if pygame.sprite.spritecollideany(player, enemies):
        pygame.mixer.Sound('C:/Users/Professional/Desktop/PP2/Lab 9/Racer/Music/Lab 9_racer_music_crash.wav').play()
        time.sleep(0.5)
